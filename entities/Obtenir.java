...
public class Obtenir implements Serializable {
    @JoinColumn(name = "id_agent", referencedColumnName = "ID", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Agents agents;
    @JoinColumn(name = "id_kiosq", referencedColumnName = "ID", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public Obtenir(int id, String idAgent, String idKiosq) {
