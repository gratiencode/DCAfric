...
public class Recquisitionner implements Serializable {
    ...
    public Recquisitionner(RecquisitionnerPK recquisitionnerPK, double quant, double prixUnit, String devise, Date date, String commentaire) {
        this.recquisitionnerPK = recquisitionnerPK;
        this.quant = quant;
    ...
    public Recquisitionner(int id, String idKiosque, String idProduit) {
